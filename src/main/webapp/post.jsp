        ...
        <div class="post-content">
            ...
            <div class="post-user clearfix">
                ...
                <div class="other-count">
                    ...
                    <j:if test="${sessionScope.uid==null}">
                        <span class="up-count"><a>赞 ${post.likeCount}</a></span>&nbsp;
                    </j:if>
                    <j:if test="${liked==true}">
            ...
            <div class="post-reply-content">
                ...
                <j:iter items="${replyList}" var="reply" status="status">
                    <div class="post-reply-item clearfix">
                        <div class="item-image"><a href="toProfile.do?uid=${reply.uid}"><img src="${reply.headUrl}"></a>
                        </div>
                        <div class="item-info">
                            ...
                            <!-- 楼中楼，即嵌套的回复内容 -->
                            <div class="item-more">
                                <j:iter items="${reply.commentList}" var="comment">
                                    <%--一个wrap开始--%>
                                    <div class="item-wrap">
                                        <div class="item-more-1">
                                            <a href="toProfile.do?uid=${comment.uid}"
                                               class="item-more-user">${comment.username}</a>
                                            <span>：</span>
...
<j:if test="${redirect == 'toPost.do?pid='}">
    <script type="text/javascript">
        window.location.href = '/toPost.do?pid=' +${replyPid};
    </script>
</j:if>
